...
static __global__ void calcUWkernel(float2* ux,float2* uz, float2* f,float2* g,int IGLOBAL)
{
...
static __global__ void calcHvgkernel(float2* hx,float2* hz,int IGLOBAL)
{
...
static __global__ void calcHvvkernel(float2* hx,float2* hy,int IGLOBAL)
{
